      ...
      <div className='programmers'>
        {
          ...
          programmers.map(programmer =>
            <div className='programmer' key={programmer.id}> {programmer.name}
               <button onClick={() => { setFeaturedID(programmer.id);/* in here set the featured id to be dev.id */ }}>Feature</button>
            </div>
          )
        }
      </div>
